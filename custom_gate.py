...
__all__ = ['CustomNaiveGate_Balance_SMoE','CustomNaiveGate_Balance_XMoE','CustomNaiveGate_Balance_StableMoE', 'CustomNaiveGate', 'CustomDropGate', 'CustomRandomGate', 'CustomRandomGate_Dense',
...
class CustomNaiveGate_Balance_SMoE(BaseGate):
    ...
    def forward(self, inp, return_all_scores=False, top_k=None):
        ...
        if self.dense_moe_flag:
            ...
            gate_top_k_val = gate_top_k_val.view(-1, k)  # (BxL) x 1 x top_k
