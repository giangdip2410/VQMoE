...
class BVectorQuantiser(nn.Module):
    """
    ...
    def forward(self, z, topk=1, temp=None, rescale_logits=False, return_logits=False):
        ...
        _, topk_indices = torch.topk(d, k=topk, dim=1)
        
        #print(sort_distance.shape, indices.shape, d.shape)
        ...
        return z_q, topk_indices, loss #, topk_indices #(perplexity, min_encodings, encoding_indices)
